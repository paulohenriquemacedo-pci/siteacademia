...
const products = [
  ...
  },
  {
    ...
    desc: "18 perguntas para descobrir seu perfil acadêmico.",
    badge: "Gratuito",
    featured: false,
    cta: "Fazer o quiz →",
  ...
  {
    title: "Webapp de Diagnóstico Completo",
    desc: "48 perguntas, laudo do seu perfil e mapa de energia de 7 dias.",
    badge: "Bônus do livro",
    featured: false,
    cta: "Incluso no livro →",
    href: "https://livro.sistemaacademia.com.br/",
  },
  {
    title: "Os 6 Dossiês de Perfil",
    desc: "Um dossiê por perfil de pesquisador, com plano de ação de 15 dias.",
    badge: "Bônus do livro",
    featured: false,
    cta: "Incluso no livro →",
    href: "https://livro.sistemaacademia.com.br/",
